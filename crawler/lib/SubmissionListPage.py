...
class SubmissionListPage:
    ...
    class Submission:
        ...
        def __init__(self, table_row: Tag) -> None:
            ...
            user_href_match: Optional[Match[str]] = self.user_href_pattern.search(user_name_tag['href'])
    ...
    def __init__(self, html: str) -> None:
        ...
        self.submissions = [SubmissionListPage.Submission(table_row) for table_row in table_rows]

        # get contest title
        contset_title_tag: Tag = soup.select('#navbar-collapse ul.nav.navbar-nav li a.contest-title')[0]
    ...
    def __repr__(self) -> str:
        return (f'<SubmissionListPage contest_title={self.contest_title} '
